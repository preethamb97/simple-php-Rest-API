<?php
// http://localhost/aws/main/links/insertNonInsertedLinks.php?key=encryption&link_name=a&link_url=https:://www.duckduckgo.com&link_img=c&status=1
...
if($isVerified) {
  $isLinkExists = $linkLib->checkIfLinkImageOrUrlAlreadyExists($linkUrl, $linkImg);
  $linkData = array(
    'link_name'=>$linkName,
    'link_url'=>$linkUrl,
    'link_img'=>$linkImg,
